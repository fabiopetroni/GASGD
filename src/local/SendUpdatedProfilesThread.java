...
public class SendUpdatedProfilesThread implements Runnable{

    private Machine machine;
    private PartitionState partition_state;

    public SendUpdatedProfilesThread(Machine m, PartitionState ps) {
        this.machine = m;
        this.partition_state = ps;
    }
    
    @Override
    public void run() {
        machine.f.sendUpdateProfiles(partition_state);
    }
}